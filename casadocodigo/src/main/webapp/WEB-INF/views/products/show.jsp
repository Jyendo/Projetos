...
<html>
<head>
<link type="text/css" href="<c:url value='/resources/css/index.css' />"
	rel="stylesheet" />
...
<body class="testCss">
	...
	<table>
		...
		<tr>
			<td><header id="product-highlight" class="clearfix">
					<div id="product-overview" class="container">
						<h1 class="product-title" itemprop="name">${product.title}</h1>
						<img width="100px" height="120px"
							src="../../${product.summaryPath}" alt="${product.title}" />
			...
			<td>
				<section class="author product-detail" itemprop="author" itemscope
					itemtype="http://schema.org/Person"></section>
			</td>
			<td>
				<h2 class="section-title" itemprop="name">${product.title}</h2> <span
